""" Creates config files for experiments and hyperparameter grid search. """
...
# Neural-linear
CfgThompsonNN = namedtuple('ThompsonFeedforwardNetwork',
                           ['order', 'periods', 'n_units',
...
def main():
    ...
    bandit = "GaussianCircularChainBandit"
    bandit_parameters = {"n_arms": 8 , "best_mean": 1, "other_mean": 0, "std": 0.05, "p_left": 0, "seed": 0}
    trial_length = 2048
    ...
    configs.append(CfgThompsonRNN(n_units=[[16, 16, 16], [32, 32, 32]],
    ...
    configs.append(CfgThompsonNN(order=[1,4],
                                 periods=[[], [2, 4, 8, 16, 32]],
                                 n_units= [[16, 16, 16], [32, 32, 32], [64, 64 ,64]],
                                 learning_rate=[0.001, 0.01, 0.1],
                                 regularise_lambda=[0.001],
                                 epochs=[16, 64],
                                 train_every=[32, 128],
